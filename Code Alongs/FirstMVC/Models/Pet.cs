...
public class Pet
{
    [Required(ErrorMessage = "This element is required. This element requires 3 or more characters.")]
    [MinLength(3)]
    [NoZNames]
    public string Name {get; set;}

    [Required(ErrorMessage = "This element is required. This element requires 2 or more characters.")]
    [MinLength(2)]
